      ...
      <tbody align=center>
         ...
         <tr>
            <c:forEach var="item" items="${myOrderList }">
               ...
               <td>
               <h2>
               <fmt:formatNumber value="${item.goods_sales_price}" type="number" />원 (10% 할인)</h2></td>
               <c:forEach var="item2" items="${cartMap.myGoodsList}">
               <c:choose>
               <c:when test="${item.goods_id == item2.goods_id }">
               <td><h2>${item2.goods_delivery_price} 원</h2>
               <c:set var="total_delivery_price" value="${ total_delivery_price + item2.goods_delivery_price}" /></td>
               </c:when>
               </c:choose>
               </c:forEach>
               ...
               <td>
                 <h2>
                 <fmt:formatNumber value="${(item.goods_sales_price) * item.order_goods_qty}" type="number" />원</h2>
   ...
   <table width=80% class="list_view" style="background: #ccffff">
      <tbody>
         ...
         <tr cellpadding=40 align=center>
            ...
            <td>
               <p id="p_totalPrice">
               <fmt:formatNumber value="${total_order_price}" type="number"  />원</p> 
            ...
            <td>
               <p id="p_totalDelivery">
               	<fmt:formatNumber value="${total_delivery_price}" type="number" var="h_totalDelivery" />${h_totalDelivery}원
               </p>
            ...
            <!-- 총 할인금액 -->
            <td>
            	<p id="p_total_sales_price">
            	<fmt:formatNumber value="${total_order_price * 0.1 }" type="number" var="h_total_sales_price" />${h_total_sales_price}원
            	</p>
               <input id="h_total_sales_price" type="hidden" value="${total_order_price * 0.1}" />
            </td>
            ...
            <td>
               <p id="p_final_totalPrice">
                  <font size="15">
                  <fmt:formatNumber value="${final_total_order_price * 0.9 -total_delivery_price}" var="h_final_total_Price" />${h_final_total_Price}원 </font>
               </p>
               <input id="h_final_total_Price" type="hidden" value="${h_final_total_Price}" />
            </td>
         </tr>
      </tbody>
   </table>
