...
public class BoardDAO05 {
	...
	public List selectAllArticles() {
		...
		try {
			...
			while(rs.next()) {
				...
				ArticleVO05 article = new ArticleVO05();
	...
	public int insertNewArticle(ArticleVO05 article) {
	...
	public ArticleVO05 selectArticle(int articleNO) {
		ArticleVO05 article = new ArticleVO05();
		try {
			conn = dataFactory.getConnection();
	...
	public void updateArticle(ArticleVO05 article) {
