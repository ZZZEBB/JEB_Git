<%@ page language="java" contentType="text/html; charset=UTF-8"
    import="java.util.*, sec03.brd01.*" isELIgnored="false" pageEncoding="UTF-8"%>
		...
		<c:when test="${!empty articlesList}">
			<c:forEach var="article" items="${articlesList}" varStatus="articleNum">
				<tr align="center">
					...
					<td width="20%"><fmt:formatDate value="${article.writeDate}"/></td>
				</tr>
			</c:forEach>
		</c:when>
	</c:choose>
	</table>
	<a class="cls1" href="#"><p class="cls2"><b>글쓰기</b></p></a>
</body>
</html>